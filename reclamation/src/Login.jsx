...
const CSS = `
  /* ... same CSS as App.jsx (fonts, navbar, btn-connect, btn-primary-nav) ... */
  ...
  .field-icon { position: absolute; left: 13px; top: 50%; transform: translateY(-50%); color: #C4C9D4; }
  .field-input {
        ...
        <div className="login-center">
          <div className="login-card">
            ...
            <div className="field-wrap">
              ...
              <input className="field-input" type="email" placeholder="nom@reclampro.fr" />
            </div>
            ...
            <div className="field-wrap">
              <span className="field-icon">🔒</span>
              <input className="field-input" type={showPwd ? "text" : "password"} defaultValue="••••••••" />
              <button onClick={() => setShowPwd(!showPwd)} style={{ position: "absolute", right: 13, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#C4C9D4" }}>
                👁
              </button>
            </div>
